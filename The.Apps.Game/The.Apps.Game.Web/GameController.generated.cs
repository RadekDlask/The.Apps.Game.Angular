...
namespace The.Apps.Game.Web.Controllers
{
    public partial class GameController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Description = "~/Views/Game/Description.cshtml";
            public readonly string Index = "~/Views/Game/Index.cshtml";
            public readonly string Play = "~/Views/Game/Play.cshtml";
        }
    }
    ...
    public partial class T4MVC_GameController : The.Apps.Game.Web.Controllers.GameController
    {
        ...
        [NonAction]
        partial void DescriptionOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int gameId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Description(int gameId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Description);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "gameId", gameId);
            DescriptionOverride(callInfo, gameId);
            return callInfo;
        }

        [NonAction]
        partial void PlayOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int gameId);

        [NonAction]
        public override System.Web.Mvc.ActionResult Play(int gameId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Play);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "gameId", gameId);
            PlayOverride(callInfo, gameId);
            return callInfo;
        }
